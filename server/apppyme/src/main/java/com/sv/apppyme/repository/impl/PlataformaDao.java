...
public class PlataformaDao implements IRepoPlataforma{
	...
	public GenericEntityResponse<Plataforma> getOneById(int id) {
		...
		GenericEntityResponse<Plataforma> res = new GenericEntityResponse<>();
		try {
	...
	public GenericEntityResponse<List<Plataforma>> getAll() {
		...
		List<Plataforma> ls = new ArrayList<>();
		GenericEntityResponse<List<Plataforma>> res = new GenericEntityResponse<>();
		Connection conn;
